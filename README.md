...
* I will use Python/Javascript/Common Lisp to solve these. Why? Because I want to learn these languages.
* The projects will not be made in the order posted.
* I will skip some of them. This list is enormous.
...
To get started, fork this repo, delete this README and rename *README-scratch.md* to *README.md*.
...
[**Fibonacci Sequence**](https://github.com/JohnnyAppleDev/MegaProjects/blob/master/numbers/fibonacci.js) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
[**Find Cost of Tile to Cover W x H Floor**](https://github.com/JohnnyAppleDev/MegaProjects/blob/master/numbers/tilecost.js) – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.
...
[**Count Vowels**](https://github.com/JohnnyAppleDev/MegaProjects/blob/master/text/vowels.py) – Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.
...
[**Vigenere / Vernam / Ceasar Ciphers**](https://github.com/JohnnyAppleDev/MegaProjects/blob/master/text/vigenere.js) – Functions for encrypting and decrypting data messages. Then send them to a friend.
